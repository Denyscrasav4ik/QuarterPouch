...
namespace QuarterPouch
{
    ...
    {
        public QuarterPouch() : base(Items.Quarter, "${0}", 0.25, new Dictionary<Items, double>() { { Items.Quarter, 0.25 } }, "quarter") { AddConversionRateIfAvailable("BeastQuarter", 0.25); AddConversionRateIfAvailable("GoldenQuarter", 0.75); }
